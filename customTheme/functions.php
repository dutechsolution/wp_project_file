...
//Custom Theme Option Through ACF
/*==================================================
			advance Custom Fields option page
  ==================================================*/
...
// Start Create Custom Post
function customTestimonial_create() {
    $labels = array(
        'name' => 'Testimonial',
    ...
    register_taxonomy("testimonial", array("testimonial"), array("hierarchical"  =>  true, "label" => "Testimonial Category", "singular_label" => "Testimonial Category",   "rewrite" => true));
}
add_action( 'init', 'customTestimonial_create' );
// End Create Custom Post 
